...
| CTA / Buttons | `#1E293B` | `--color-cta` |
| On CTA | `#FFFFFF` | `--color-cta-foreground` |
| Accent/Success | `#16A34A` | `--color-accent` |
...
**Color Notes:** Light canvas only. Frosted white glass + status green. Do not switch this product to a dark background.
